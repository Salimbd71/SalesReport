      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row lg:flex-col gap-3 shrink-0">
          ...
          <button
            ...
            className="group px-5 py-3.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 disabled:opacity-75 disabled:cursor-not-allowed text-white rounded-xl font-semibold shadow-lg shadow-emerald-900/30 transition-all flex items-center justify-between space-x-3 text-xs cursor-pointer border border-emerald-400/30"
          >
            <div className="flex items-center space-x-3 text-left">
              ...
              <div>
                <div className="font-bold text-sm">
                  {isExportingConsolidated ? 'Generating File...' : 'Consolidated File.xlsx'}
                </div>
                <div className="text-[11px] text-emerald-100">
                  {isExportingConsolidated ? 'Compiling 4 sheets...' : 'With FLM, HQ, Brand, Chemist & Pivot'}
                </div>
              </div>
            </div>
            {isExportingConsolidated ? (
          ...
          <button
            ...
            className="group px-5 py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 disabled:opacity-75 disabled:cursor-not-allowed text-white rounded-xl font-semibold shadow-lg shadow-blue-900/30 transition-all flex items-center justify-between space-x-3 text-xs cursor-pointer border border-blue-400/30"
          >
            <div className="flex items-center space-x-3 text-left">
              <div className="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center">
                {isExportingPivot ? (
              ...
              <div>
                <div className="font-bold text-sm">
                  {isExportingPivot ? 'Generating Pivot...' : 'SALES REPORT PIVOT.xlsx'}
                </div>
                <div className="text-[11px] text-blue-100">
                  {isExportingPivot ? 'Formatting In Lac...' : 'Rows: FLM, HQ | Cols: BRAND | Value: Sales'}
                </div>
              </div>
            </div>
            {isExportingPivot ? (
