      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5 sm:gap-6">
        ...
        <div className="flex flex-col gap-3 shrink-0 lg:max-w-md w-full lg:w-auto">
            ...
            <div className="flex items-center space-x-3.5 text-left">
              ...
              <div>
                ...
                <div className="text-[11px] text-emerald-200/90 mt-0.5">
                  {isExportingConsolidated
                    ? isCompareMode
                      ? (language === 'bn' ? 'Current Month vs Last Month সহ ৫টি শীট সংকলন করা হচ্ছে...' : 'Compiling 5 sheets including Current Month vs Last Month...')
                      : (language === 'bn' ? '৪টি শীট সংকলন করে ফাইল প্রস্তুত করা হচ্ছে...' : 'Compiling 4 sheets & formatting in Lac...')
                    : isCompareMode
                    ? (language === 'bn' ? 'তুলনামূলক ৫টি শীট সহ এক্সেল ফাইল ডাউনলোড' : 'Download Complete 5-Sheet Excel File with MoM Comparison')
                    : t.downloadConsolidatedSub}
                </div>
              </div>
            </div>
            {isExportingConsolidated ? (
          ...
          <div className="text-[11px] text-slate-400 flex items-center justify-between px-1">
            <span>
              {isCompareMode
                ? (language === 'bn' ? '✓ পিভট ও Current Month vs Last Month সহ ৫টি শীট' : '✓ Includes Pivot Table & all 5 sheets (with Current Month vs Last Month)')
                : (language === 'bn' ? '✓ পিভট টেবিল সহ ৪টি শীট অন্তর্ভুক্ত' : '✓ Includes Pivot Table & all 4 sheets')}
            </span>
