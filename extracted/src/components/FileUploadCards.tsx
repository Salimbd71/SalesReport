  ...
  return (
    <div id="file-upload-section" className="mb-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-xs sm:text-sm text-slate-300 mt-2 leading-relaxed">
              Select your Sales Data file and Chemist list file, then click "Generate Sales Report". The engine performs VLOOKUP mapping into Columns P (FLM) & Q (HQ), maps BRAND from Column G (G2), and generates multi-level Pivot tables with sales values in Lac (100,000 = 1.00).
            </p>
          </div>

          {/* Developer Card as shown in screenshot */}
          <div className="bg-slate-950/80 rounded-xl p-3.5 border border-slate-800 text-[11px] text-slate-300 shrink-0 space-y-1 min-w-[280px]">
            <div className="flex items-center space-x-2 font-semibold text-xs text-white">
              <span className="w-2 h-2 rounded-full bg-emerald-400"></span>
              <span>Developed by <span className="text-emerald-400">Salim</span></span>
            </div>
            <div className="text-slate-400 pl-4">SO, Sun Pharmaceuticals EZ Ltd.</div>
            <div className="text-slate-400 pl-4">HQ - ENGLISH ROAD-AZU-DHAKA</div>
            <div className="text-slate-400 pl-4">Mail - mdsalim.hossain1@sunpharma.com</div>
            <div className="text-slate-400 pl-4">Mobile - 01737462871</div>
          </div>
        </div>
      </div>
      ...
      >
          ...
          <div className="flex items-center space-x-3.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                Enable to upload Last month sales report & compare Sheet 2 (HQ-Customer Sales) with <span className="text-rose-600 dark:text-rose-400 font-medium">Deficit</span> tracking.
              </p>
            </div>
          </div>
        ...
        {isCompareMode && (
          <div className="mt-3.5 pt-3 border-t border-slate-100 dark:border-slate-800 flex flex-wrap items-center gap-3 text-xs">
            <span className="inline-flex items-center px-3 py-1 rounded-md bg-indigo-50/80 dark:bg-indigo-950/40 text-indigo-700 dark:text-indigo-300 text-[11px] border border-indigo-100 dark:border-indigo-900/50">
              Sheet 2 Column: SALES_VALUE_CURRENT
            </span>
            <span className="inline-flex items-center px-3 py-1 rounded-md bg-purple-50/80 dark:bg-purple-950/40 text-purple-700 dark:text-purple-300 text-[11px] border border-purple-100 dark:border-purple-900/50">
              Sheet 2 Column: SALES_VALUE_LAST
            </span>
            <span className="inline-flex items-center px-3 py-1 rounded-md bg-rose-50/80 dark:bg-rose-950/40 text-rose-700 dark:text-rose-300 text-[11px] border border-rose-100 dark:border-rose-900/50">
              Sheet 2 Column: Deficit (- value red text)
            </span>
          </div>
        )}
      </div>
      ...
      <div className={`grid grid-cols-1 ${isCompareMode ? 'lg:grid-cols-3 gap-5' : 'md:grid-cols-2 gap-6'}`}>
        ...
        >
          ...
          <div className="mt-3.5">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
              শর্ত: Sun Mail এর Data Centrebd এর সেলস রিপোর্ট ফাইল আপলোড করতে হবে।
            </p>
            ...
            <div className="my-3 p-2.5 rounded-lg bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 text-xs space-y-1 text-slate-600 dark:text-slate-300">
              ...
              <p className="pl-5 text-[11px] text-slate-500 dark:text-slate-400">
                • Cell A1: Date text preserved
              </p>
              <p className="pl-5 text-[11px] text-emerald-600 dark:text-emerald-400 font-medium">
                • Sheet 4: Col G (BRAND), Col P2 (FLM) & Col Q2 (HQ)
              </p>
              <p className="pl-5 text-[11px] text-teal-600 dark:text-teal-400 font-medium">
                • Sheet 2: Col K2 (FLM) & Col L2 (HQ)
              </p>
            </div>
        ...
        >
          ...
          <div className="mt-3.5">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
              শর্ত: RSM Sir এর দেওয়া নির্দিষ্ট কেমিস্ট ফাইল আপলোড করতে হবে।
            </p>
            ...
            <div className="my-3 p-2.5 rounded-lg bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 text-xs space-y-1 text-slate-600 dark:text-slate-300">
              ...
              <p className="pl-5 text-[11px] text-slate-500 dark:text-slate-400">
                • Lookup Key: Cust code
              </p>
              <p className="pl-5 text-[11px] text-slate-500 dark:text-slate-400">
                • FLM: Col I (FSM- ( NEW) 2026-27)
              </p>
              <p className="pl-5 text-[11px] text-slate-500 dark:text-slate-400">
                • HQ: Col K (AZURA HQ ( New Design))
              </p>
            </div>
        ...
        {isCompareMode && (
          ...
          >
            ...
            <div className="mt-3.5">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                Same format as Sales data file from data centrebd• Reads Sheet 2 (HQ-Customer Sales)
              </p>
              ...
              <div className="my-3 p-2.5 rounded-lg bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 text-xs space-y-1 text-slate-600 dark:text-slate-300">
                ...
                <p className="pl-5 text-[11px] text-rose-600 dark:text-rose-400 font-medium">
                  • Deficit: Current - Last (Negative in red text)
                </p>
              </div>
