        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-800/60 disabled:cursor-not-allowed text-white rounded-lg text-xs font-medium flex items-center space-x-1.5 shadow-sm cursor-pointer ml-auto"
            >
              {isExportingPivot ? (
              ...
              <span>{isExportingPivot ? 'Exporting Pivot...' : 'Export SALES REPORT PIVOT.xlsx'}</span>
            </button>
          </div>
        </div>
      </div>
