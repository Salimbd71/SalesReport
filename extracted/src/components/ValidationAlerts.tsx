...
export const ValidationAlerts: React.FC<ValidationAlertsProps> = ({
  ...
  if (!salesValidation && !chemistValidation) return null;

  return (
    <div id="validation-section" className="space-y-3 mb-6">
      {/* Sales File Validation Warning / Status */}
      {salesValidation && (
        <div
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs mt-1 text-slate-600 dark:text-slate-300">
                  {hasSalesIssues
                    ? 'Some columns or sheet configuration differed from the standard format. Check details below.'
      ...
      {/* Chemist File Validation Warning / Status */}
      {chemistValidation && (
        <div
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <div className="flex items-center space-x-2">
                  <h4 className="font-semibold text-sm">
                    Chemist List File Validation: {hasChemistIssues ? 'Formatting Notice' : 'Format Verified'}
                  </h4>
                  <span className="text-xs px-2 py-0.5 rounded-full font-mono bg-white/60 dark:bg-slate-800/60 border border-current/20">
                ...
                <p className="text-xs mt-1 text-slate-600 dark:text-slate-300">
                  {hasChemistIssues
                    ? 'Expected sheet DHK-MYN-KH or target columns (Cust code, Col I: FSM-(NEW)2026-27, Col K: AZURA HQ (New Design)-2026-27) needed mapping.'
