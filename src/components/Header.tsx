            ...
            {hasData && (
              <>
                <button
                  ...
                  className="inline-flex items-center space-x-1.5 px-3.5 py-2 bg-blue-600 hover:bg-blue-500 text-white text-xs font-medium rounded-lg shadow-sm transition-all cursor-pointer"
                  title="Download SALES REPORT PIVOT.xlsx"
                >
                  <Layers className="w-4 h-4" />
                  <span>Pivot Report (.xlsx)</span>
                </button>
                <button
                  id="btn-export-consolidated-header"
                  onClick={onExportConsolidated}
                  className="inline-flex items-center space-x-1.5 px-3.5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-medium rounded-lg shadow-sm transition-all cursor-pointer"
                ...
                <button
                  id="btn-reset-data"
                  onClick={onReset}
                  className="inline-flex items-center space-x-1 px-3 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-medium rounded-lg border border-slate-700 transition-all cursor-pointer"
